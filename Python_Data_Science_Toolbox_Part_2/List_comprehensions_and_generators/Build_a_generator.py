...
# comprehension syntax for generator expressions made your work so 
# much easier!
...
# In this exercise, you will create a generator function with a 
# similar mechanism as the generator expression you defined in the 
# previous exercise:
...
# In the for loop in the function definition, yield the length of the 
# strings in input_list.
