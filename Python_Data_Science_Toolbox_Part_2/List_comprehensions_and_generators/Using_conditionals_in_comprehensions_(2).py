...
# In the previous exercise, you used an if conditional statement in 
# the predicate expression part of a list comprehension to evaluate 
# an iterator variable. In this exercise, you will use an if-else 
...
# expression, create a list that keeps members of fellowship with 7 
# or more characters and replaces others with an empty string. Use 
# member as the iterator variable in the list comprehension.

# INSTRUCTIONS

# In the output expression, keep the string as-is if the number of 
# characters is >= 7, else replace it with an empty string - that 
# is, '' or "".
