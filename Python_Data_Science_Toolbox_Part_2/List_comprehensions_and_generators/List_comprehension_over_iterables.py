...
# underwood = 'After all, we are nothing more or less than what 
# we choose to reveal.'

# jean = '24601'

# flash = ['jay garrick', 'barry allen', 'wally west', 'bart 
# allen']
...
# the string of number characters jean.

# You can build list comprehensions over all the objects except 
# the string lists doctor and flash.

# You can build list comprehensions over all the objects except 
# range(50).

# You can build list comprehensions over all the objects except 
# the integer object valjean.
