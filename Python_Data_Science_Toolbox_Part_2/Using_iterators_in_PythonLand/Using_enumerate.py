...
# You've just gained several new ideas on iterators from the last 
# video and one of them is the enumerate() function. Recall that 
...
# you will practice using enumerate() on it by printing out a list 
# of tuples and unpacking the tuples using a for loop.
...
# Complete the second for loop similarly as with the first, but 
# this time change the starting index to start from 1 by passing 
# it in as an argument to the start parameter of enumerate(). Use 
# index2 for the index and value2 for the value when unpacking the 
# tuple.
