...
# You know how to use zip() as well as how to print out values 
# from a zip object. Excellent!

# Let's play around with zip() a little more. There is no unzip 
# function for doing the reverse of what zip() does. We can, 
# however, reverse what has been zipped together by using zip() 
# with a little help from *! * unpacks an iterable such as a list 
# or a tuple into positional arguments in a function call.

# In this exercise, you will use * in a call to zip() to unpack 
# the tuples produced by zip().

# Two tuples of strings, mutants and powers have been pre-loaded.

# INSTRUCTIONS

# Create a zip object by using zip() on mutants and powers, in that 
# order. Assign the result to z1.
...
# result1 to mutants and result2 to powers. Click Submit Answer 
# to see if the unpacked result1 and result2 are equivalent to 
