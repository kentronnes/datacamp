...
# Let's work more on your mastery of scope. In this exercise, 
# you will use the keyword global within a function to alter the 
# alue of a variable defined in the global scope.
