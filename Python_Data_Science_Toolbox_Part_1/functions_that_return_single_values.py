...
# modification to the shout() function so that it now returns a
# single value instead of printing within the function. Recall
# that the return keyword lets you return values from functions.
# Parts of the function shout(), which you wrote earlier, are
# shown. Returning values is generally more desirable than
# printing them out because, as you saw earlier, a print() call
